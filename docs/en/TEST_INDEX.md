...
**6179 tests across 296 files**, organised by theme (measured on the suite
that ships with this release: `6179 passed, 21 skipped`).
...
The number that is measured is the one above.
