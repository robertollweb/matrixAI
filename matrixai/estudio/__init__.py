...
__all__ = [
    ...
    "ALCANCES_DE_VALIDACION", "BENEFICIO_NETO_NO_TRATAR", "NPV_A_PREVALENCIA",
    "PPV_A_PREVALENCIA", "VERSION_DEL_PERFIL", "CurvaDeDecision", "FilaDeUmbral",
    "PerfilClinico", "PuntoDeDecision", "TablaDeUmbrales", "alcance_de_validacion",
    "beneficio_neto", "curva_de_decision", "ficha_del_perfil", "tabla_de_umbrales",
    ...
    "aplazamiento", "aptitud", "calcular", "catalogo", "digest_del_catalogo", "nombre_de_la_metrica",
