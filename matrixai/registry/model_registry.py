...
class ModelRegistry:
    ...
    def push_run_dir(
        ...
        *,
        ...
        params.json / params.best.json, and training_trace.json.  Artifacts are
        copied into the registry entry directory and their content is hashed to
        build the immutable entry_hash chain.
        """
        from matrixai.registry.entry_hash import sha256_bytes
        ...
        for candidate in ("params.best.json", "params.json"):
    ...
    def pull(self, name: str, version: str, target_registry: "ModelRegistry") -> None:
        ...
        for key in ("model", "params", "training_trace", "evaluation_report"):
